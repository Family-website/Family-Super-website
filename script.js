...
// 🛡️ 10. REAL GEMINI AI CHAT & VOICE (FULLY FIXED)
async function sendToRealAI() {
    ...
    try {
        // 🔥 FIX: Changed model to gemini-1.5-flash-latest to avoid "not found" error.
        ...
        if (!response.ok) {
            ...
            // Agar API Key ya Model me dikkat hui, to saaf-saaf batayega
...
function openAIBottomSheet() {
    Swal.fire({
        title: '🤖 AI Assistant',
        // 🔥 FIX: Wapas add kiya gaya hai Input Box (Screenshot me jo miss tha)
